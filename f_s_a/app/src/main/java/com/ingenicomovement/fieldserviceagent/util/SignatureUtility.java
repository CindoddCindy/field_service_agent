...
public class SignatureUtility {
   ...
   public static String doSignatures(String datetime) {
        md5Utility      = new MD5Utility();

        String _signature = md5Utility.doMD5(md5Utility.doMD5(datetime)  + md5Utility.doMD5("0a5941c1-e4bd-471c-8ceb-ecc1a940eb57"));
        return _signature;
